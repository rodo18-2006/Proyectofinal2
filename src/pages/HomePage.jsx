...
export default function HomePage() {
   const allTestimonials = [
    ...
    { name: "Bautista Alavaréz", comment: "El mejor gimnasio de todos.", rating: 5 },
    { name: "Juan Bulacio", comment: "Ambiente ideal para entrenar.", rating: 5 },
  ...
  const currentTestimonials = allTestimonials.slice(indexOfFirstItem, indexOfLastItem);
